...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('caribarangjual', [App\Http\Livewire\Penjualan::class, 'caribarangjual'])->name('caribarangjual');
    Route::get('caribarangbeli', [App\Http\Livewire\Pembelian::class, 'caribarangbeli'])->name('caribarangbeli');
