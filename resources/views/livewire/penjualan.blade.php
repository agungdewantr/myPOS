    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
              ...
              <form wire:submit.prevent="save" name="tambah" onsubmit="return validateForm()">
                <div class="row">
                <div class="col-8">
                ...
                <div class="col-4">
                  ...
                  <div class="col-12 mt-2">
                    <button class="col-12 btn btn-primary" style="background-color: #9e7cf4; border:none;" type="submit" style="border:none;"><i class="fas fa-cart-plus" style="margin-right=5px;"></i><p class="d-inline">Masukkan Keranjang</p></button>
                  </div>
              </form>
            </div>
        </div>
      ...
      <div class="row">
          <div class="col-12 mt-2">
            <button class="col-12 btn btn-primary" style="background-color: #9e7cf4; border:none;" type="submit" style="border:none;"><i class="fas fa-plus"></i><p class="d-inline">Save</p></button>
          </div>
      </div>
      </form>
    </div>
